...
const Login = ({ setShowLogin }) => {
    ...
    return (
        <div className='absolute z-10 w-full h-screen flex justify-center ' style={{background: "#00000090"}}>
            <ChakraProvider>
                <form className=' w-max self-center  bg-white gap-3 p-7 px-10 rounded-lg text-lg flex flex-col' style={{color:"#808080", animation: "fadeIn 0.5s"}}>
                <div className='flex justify-between'>
                    ...
                    <Button colorScheme='blue'>{currState==="Sign Up"?"Create account":"Login"}</Button>
