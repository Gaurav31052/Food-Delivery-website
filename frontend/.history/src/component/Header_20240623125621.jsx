  ...
  return <>
      ...
      <div className='h-96 relative'>
        <div className='absolute flex-col flex max-w-2xl bottom-0 right-0 text-white gap-4 p-2'>
            ...
            <div><p>lorembahf daduhd dadiuhaiudhq eaebcbcccdd  huduhduqhdu qudhuhdqh ddqdhuhqwud duqhdqwhd qdhqwhd dqhduqh dqdhqhdjhfsf ehf wf wfeifwfhw fwfwhfwfwf fuhfuwhuhfw fwfhuwhef wf hwue fwf wefhuwuhf.</p></div>
